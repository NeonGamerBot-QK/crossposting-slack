...
app.command("/crossposting-optout", async (par) => {
  ...
  await par.say(
    "You have opted out of crossposting. You will no longer be able to use me. to opt back in please dm <@U07L45W79E1> or delte your data with /crossposting-deletemydata",
  );
});
